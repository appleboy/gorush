...
[![Run Lint and Testing](https://github.com/eencloud/gorush/actions/workflows/testing.yml/badge.svg)](https://github.com/eencloud/gorush/actions/workflows/testing.yml)
[![GoDoc](https://godoc.org/github.com/eencloud/gorush?status.svg)](https://pkg.go.dev/github.com/eencloud/gorush)
[![codecov](https://codecov.io/gh/appleboy/gorush/branch/master/graph/badge.svg)](https://codecov.io/gh/appleboy/gorush)
[![Go Report Card](https://goreportcard.com/badge/github.com/eencloud/gorush)](https://goreportcard.com/report/github.com/eencloud/gorush)
...
The pre-compiled binaries can be downloaded from [release page](https://github.com/eencloud/gorush/releases).

With `Go` installed

```sh
go install github.com/eencloud/gorush
```

On linux

```sh
wget https://github.com/eencloud/gorush/releases/download/v1.18.9/gorush-1.18.9-linux-amd64 -O gorush
```

On macOS (Intel amd64)

```sh
wget -c https://github.com/eencloud/gorush/releases/download/v1.18.9/gorush-1.18.9-darwin-amd64 -O gorush
```

On macOS (Apple arm64)

```sh
wget -c https://github.com/eencloud/gorush/releases/download/v1.18.9/gorush-1.18.9-darwin-arm64 -O gorush
```
...
mkdir $HOME/src
cd $HOME/src
git clone https://github.com/eencloud/gorush.git
cd gorush
go install
```
...
go install github.com/eencloud/gorush@master
```
...
Support send notification from different environment. See the detail of [issue](https://github.com/eencloud/gorush/issues/246).
...
[build.environment]
GO111MODULE = "on"
GO_IMPORT_PATH = "github.com/eencloud/gorush"
GO_VERSION = "1.21.11"
